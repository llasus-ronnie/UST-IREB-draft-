...
import { Container, Row, Form, FormLabel, FormSelect, FormControl, Button } from 'react-bootstrap';
  ...
  const handleSubmit = (event) => {
    ...
    if (file) {
      ...
      if (!['pdf', 'doc', 'docx'].includes(fileType)) {
        event.preventDefault();
        event.stopPropagation();
        fileInput.setCustomValidity('Please upload PDF, DOC, or DOCX files only.');
      } else {
        ...
        <Container className='rescont3'>
          ...
          <Row>
            <Form noValidate validated={validated} onSubmit={handleSubmit}>
              ...
              <Form.Control.Feedback type='invalid'>Please select a file type.</Form.Control.Feedback>
              ...
              <FormControl
                ...
                required
              />
              <Form.Control.Feedback type='invalid'>Please upload a PDF, DOC, or DOCX file.</Form.Control.Feedback>
              ...
              <Row style={{ marginTop: '20px', paddingBottom: '20px' }} className='justify-content-around'>
                ...
                <Button type='submit' variant='outline-warning' className='formbtn'>Submit</Button>  
              </Row>
            </Form>
          </Row>
        </Container>
